...
/**
 * Split-screen visual marker. Real client-level dual-camera rendering is kept in the
 * version-specific compatibility layer because Forge's visual pipeline differs by version.
 */
